 ...
 */
    ...
    class bags_ownersPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Bags Owners');
            $this->SetMenuLabel('Bags Owners');
            ...
            $this->dataset->addFields(
                array(
                    new StringField('First_name', true, true),
                    new StringField('Last_name', false, true),
                    new IntegerField('Bag_number', true, true)
                )
            );
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'Bag_number', 'Bag_number', 'Bag Number')
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('bag_number_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $grid->AddViewColumn($column);
            //
            // View column for Bag_number field
            //
            $column = new NumberViewColumn('Bag_number', 'Bag_number', 'Bag Number', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for Bag_number field
            //
            $editor = new TextEdit('bag_number_edit');
            $editColumn = new CustomEditColumn('Bag Number', 'Bag_number', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
    ...
    try
    {
        $Page = new bags_ownersPage("bags_owners", "bags_owners.php", GetCurrentUserPermissionsForPage("bags_owners"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("bags_owners"));
