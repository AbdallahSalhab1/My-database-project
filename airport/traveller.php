 ...
 */
    ...
    class traveller_traveller_phonenumberPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_traveller_traveller_phonenumber_travellerid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('travellerid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_traveller_traveller_phonenumber_travellerid_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Travellerid', 'travellerid', 'travellerid_Fname', 'edit_traveller_traveller_phonenumber_travellerid_search', $editor, $this->dataset, $lookupDataset, 'id', 'Fname', '');
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Fname', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Travellerid', 'travellerid', 'travellerid_Fname', 'insert_traveller_traveller_phonenumber_travellerid_search', $editor, $this->dataset, $lookupDataset, 'id', 'Fname', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Fname', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_traveller_traveller_phonenumber_travellerid_search', 'id', 'Fname', null, 20);
            ...
            $lookupDataset->setOrderByField('Fname', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_traveller_traveller_phonenumber_travellerid_search', 'id', 'Fname', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Fname', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_traveller_traveller_phonenumber_travellerid_search', 'id', 'Fname', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class travellerPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Traveller');
            $this->SetMenuLabel('Traveller');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new ComboBox('gender_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('traveller.traveller_phonenumber')->HasViewGrant() && $withDetails)
            {
            //
            // View column for traveller_traveller_phonenumber detail
            //
            $column = new DetailColumn(array('id'), 'traveller.traveller_phonenumber', 'traveller_traveller_phonenumber_handler', $this->dataset, 'Traveller Phonenumber');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new ComboBox('gender_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
        ...
        protected function doRegisterHandlers() {
            $detailPage = new traveller_traveller_phonenumberPage('traveller_traveller_phonenumber', $this, array('travellerid'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('traveller.traveller_phonenumber'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('traveller.traveller_phonenumber'));
            $detailPage->SetHttpHandlerName('traveller_traveller_phonenumber_handler');
            $handler = new PageHTTPHandler('traveller_traveller_phonenumber_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new travellerPage("traveller", "traveller.php", GetCurrentUserPermissionsForPage("traveller"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("traveller"));
